...
def plot_prr_rc_cc(data_class, output_pdf_name):
    # create plot
...
# harq vs no harq
def plot_prr_harq_no_harq(data_class, output_pdf_name):
    # create plot
...
def get_congestion_control_data():
    ...
    val_j3161 = ec.get_kpi_val_from_file("../v2x_trace_for_plot/distVSprr_J3161_10KMH.txt")
    val_j3161_10mhz = ec.get_kpi_val_from_file("../v2x_trace_for_plot/distVSprr_J3161_10MHz_10KMH.txt")
    val_j3161_pc = ec.get_kpi_val_from_file("../v2x_trace_for_plot/distVSprr_J3161_PC_10KMH.txt")
    val_j3161_pc_10mhz = ec.get_kpi_val_from_file("../v2x_trace_for_plot/distVSprr_J3161_PC_10MHz_10KMH.txt")
...
def get_harq_no_harq_data():
    val_j3161 = ec.get_kpi_val_from_file(
        "../v2x_trace_for_plot/distVSprr_J3161_10KMH.txt")
    val_j3161_10mhz = ec.get_kpi_val_from_file(
        "../v2x_trace_for_plot/distVSprr_J3161_10MHz_10KMH.txt")
    val_j3161_no_harq = ec.get_kpi_val_from_file(
        "../v2x_trace_for_plot/distVSprr_J3161_NO_HARQ_10KMH.txt")
    val_j3161_10mhz_no_harq = ec.get_kpi_val_from_file(
        "../v2x_trace_for_plot/distVSprr_J3161_10MHz_NO_HARQ_10KMH.txt")
...
if __name__ == '__main__':
    ...
    plot_prr_rc_cc(data_class=rc_pc_class, output_pdf_name='dist_vs_prr_rc_pc_10kmh.pdf')

    harq_class = get_harq_no_harq_data()
    plot_prr_harq_no_harq(data_class=harq_class, output_pdf_name='dist_vs_prr_harq_no_harq_10kmh.pdf')




    print "Plotting PRR finished"
