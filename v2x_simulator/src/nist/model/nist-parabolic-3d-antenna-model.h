...
#ifndef NIST_PARABOLIC_3D_ANTENNA_MODEL_H
#define NIST_PARABOLIC_3D_ANTENNA_MODEL_H
 ...
 *
 */
class NistParabolic3dAntennaModel : public AntennaModel
{
public:
...
#endif // NIST_PARABOLIC_3D_ANTENNA_MODEL_H
